                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 wow fadeInUp animated" data-wow-delay="300ms">
                        <div class="login-page__wrap">
                            <h3 class="login-page__wrap__title text-center">Courses</h3>
                            <table class="table table-bordered table-striped table-responsive">
                            <?php if(isset($_REQUEST['msg']) && $_REQUEST['msg']!== '') { ?>
                                <div class="alert alert-danger" role="alert">Course deleted successfully!!!!! <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
                            ...
                            <thead>
                                ...
                                <th class="text-n500">Icon</th>
                                <th class="text-n500">Duration</th>
                                <th class="text-n500">Picture</th>
                            ...
                            <tbody>
                                ...
                                $total_result=$db->query("SELECT COUNT(*) as total FROM courses");
                                ...
                                $e1=$db->query("select * from courses order by c_id desc LIMIT $offset, $limit");
                                ...
                                <td><?php echo $e['icon']; ?></td>
                                <td><?php echo $e['duration']; ?></td>
                                <td><img src="<?php echo $e['pic']; ?>" width="100px" height="100px" /></td>
                                <td>
                                    <a href="upcourse?c_id=<?php echo $e['c_id']; ?>"
                                    ...
                                    &nbsp;
                                    <a href="delcourse?c_id=<?php echo $e['c_id']; ?>&page=<?php echo $page; ?>"
